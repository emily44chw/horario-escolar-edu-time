...
@section('content')
    ...
    <script>
        $(document).ready(function () {
            var assignments = []; // Array para almacenar asignaciones

            // Al seleccionar curso, cargar asignaturas y mostrar formulario
            $('#course-select').change(function () {
                ...
                if (courseId) {
                    $.get('/schedules/subjects/' + courseId, function (data) {
                        ...
                        $('#schedule-form').show(); // Mostrar formulario aquí
            ...
            // Al cambiar asignatura o día, cargar slots
            $('#subject-select, #day-select').change(function () {
                ...
                if (courseId && subjectId && day) {
                    ...
                    console.log('Faltan parámetros para slots');
                }
            });
